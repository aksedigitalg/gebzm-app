    ...
    <div className="space-y-4">
      ...
      {selectedDay && (
        <div className="space-y-2">
          <p className="text-xs font-semibold text-muted-foreground">{selectedDay} {monthName} rezervasyonları</p>
          {selectedReservations.length === 0 ? (
            <p className="text-sm text-muted-foreground">Bu gün için rezervasyon yok.</p>
        ...
        <>
          ...
          {filtered.length === 0 ? (
            <div className="flex flex-col items-center py-16 text-center">
              ...
              <p className="mt-3 text-sm text-muted-foreground">Bu filtrede rezervasyon yok.</p>
            </div>
          ) : (
